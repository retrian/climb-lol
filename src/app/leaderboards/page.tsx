      ...
      <div className="mx-auto max-w-4xl px-4 py-10 lg:py-16">
        ...
        <div className="space-y-3">
              ...
              <div className="p-5 lg:p-6">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <h2 className="text-lg lg:text-xl font-bold text-slate-900 group-hover:text-slate-700 transition-colors truncate dark:text-slate-100 dark:group-hover:text-white">
                      {lb.name}
                    </h2>
                    {lb.description && (
                  ...
                  {/* Arrow Icon */}
                  <div className="flex-shrink-0 text-slate-400 group-hover:text-slate-600 group-hover:translate-x-1 transition-all duration-200 dark:text-slate-500 dark:group-hover:text-slate-300">
          ...
          {(leaderboards ?? []).length === 0 && (
            <div className="text-center py-16 bg-white rounded-2xl border-2 border-dashed border-slate-200 dark:bg-slate-900 dark:border-slate-700">
